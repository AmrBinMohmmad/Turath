...
$sql = "SELECT u.id, u.username, u.email, u.level, u.xp, u.created_at, (SELECT COUNT(*) FROM if0_40458841_projects.annotations a WHERE a.user_id = u.id) as total_answers FROM if0_40458841_users_db.users u ORDER BY u.xp DESC";
            ...
            <table>
                ...
                <tbody>
                    <?php if ($users && $users->num_rows > 0):
                        ...
                        <?php endwhile; else:
                        echo "<tr><td colspan='7' style='text-align:center;'>لا يوجد طلاب مسجلين بعد.</td></tr>"; endif; ?>
                </tbody>
            </table>
        </div>
    </main>
